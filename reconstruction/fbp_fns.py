...
def reconstruct(im, output_dir, rescale=False, verbose=True):
    if rescale:
        ...
        if output_dir is None:
            reconstruction_fbp = run_fbp(im, output_dir=output_dir, minmax=[min_val, max_val], save_recon=False, progbar=False)
        else: 
